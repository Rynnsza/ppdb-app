...
<head>
    ...
    <title>Jalur Pendaftaran - PPDB Online 2026</title>
        ...
        <section class="py-20 bg-white">
            <div class="container mx-auto px-6">
                <div class="text-center mb-12">
                    <h1 class="text-3xl md:text-4xl font-bold text-gray-900">Jalur Pendaftaran PPDB 2026</h1>
                ...
                <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8">
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-start">
                            ...
                            <span class="ml-4 text-gray-700">Berusia maksimal 15 tahun</span>
                        </li>
                        <li class="flex items-start">
                            <div class="bg-sky-100 text-sky-600 rounded-full h-6 w-6 flex items-center justify-center flex-shrink-0 mt-1">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
