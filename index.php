...
<!-- Hero Section -->
<section id="beranda" class="relative pt-20 pb-24 overflow-hidden">
    <!-- Background Image -->
    <div class="absolute inset-0 z-0">
        ...
        <div class="absolute inset-0 bg-gradient-to-r from-blue-900/70 to-sky-800/70"></div>
    </div>
    
    <!-- Konten -->
    <div class="container mx-auto px-6 text-center relative z-10">
        <div class="max-w-3xl mx-auto">
            <h1 class="text-4xl md:text-6xl font-extrabold text-white mb-4 leading-tight">Selamat Datang di Portal PPDB Online 2026</h1>
            <p class="text-lg md:text-xl text-gray-200 mb-8">Penerimaan Peserta Didik Baru kini lebih mudah, cepat, dan transparan. <?php if (!isset($_SESSION['user_id'])): ?>Daftarkan putra-putri terbaik Anda melalui portal resmi kami.<?php else: ?>Selamat datang kembali, <?php echo htmlspecialchars($_SESSION['username'] ?? 'Pengguna'); ?>!<?php endif; ?></p>
            <?php if (!isset($_SESSION['user_id'])): ?>
                <a href="register.php" class="cta-button bg-white text-sky-600 font-bold py-3 px-8 rounded-lg text-lg hover:bg-gray-100 hover:shadow-lg inline-block transition duration-300">Mulai Pendaftaran</a>
            <?php else: ?>
                <a href="dashboard_<?php echo $_SESSION['user_role']; ?>.php" class="cta-button bg-white text-sky-600 font-bold py-3 px-8 rounded-lg text-lg hover:bg-gray-100 hover:shadow-lg inline-block transition duration-300">Ke Dashboard</a>
            <?php endif; ?>
        </div>
    </div>
</section>
...
<section id="informasi" class="py-20 bg-white">
    <div class="container mx-auto px-6">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900">Jalur Pendaftaran PPDB 2026</h2>
...
<section id="jadwal" class="py-20 bg-white">
    <div class="container mx-auto px-6">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900">Jadwal Penting PPDB 2026</h2>
